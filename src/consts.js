...
export const DEFAULT_NAME = window.DEFAULT_NAME || process.env.VUE_APP_DEFAULT_NAME || 'default cluster'
export const DEFAULT_HOST = window.DEFAULT_HOST || process.env.VUE_APP_DEFAULT_HOST || 'http://localhost:9200'
